package com.java.smboard.member.controller;

import com.java.smboard.member.model.MemberModel;
import com.java.smboard.member.service.MemberService;
import com.java.smboard.member.service.MemberValidation;
...
public class MemberController {
	...
	public ModelAndView addMember(@ModelAttribute("MemberModel") MemberModel memberModel, BindingResult result){
		...
		new MemberValidation().validate(memberModel, result); 
		if(result.hasErrors()){
